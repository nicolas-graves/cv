...
Local Variables:
eval: (setq org-latex-logfiles-extensions (quote ("lof" "lot" "tex~" "aux" "idx" "log" "out" "toc" "nav" "snm" "vrb" "dvi" "fdb_latexmk" "blg" "brf" "fls" "entoc" "ps" "spl" "bbl" "xmpi" "run.xml" "bcf")))
...
eval: (setq org-latex-pdf-process
              '("guix time-machine --channels=channels.scm -- shell -m manifest.scm -- lualatex -shell-escape -interaction nonstopmode -output-directory %o %f"
                "guix time-machine --channels=channels.scm -- shell -m manifest.scm -- lualatex -shell-escape -interaction nonstopmode -output-directory %o %f"
                "guix time-machine --channels=channels.scm -- shell -m manifest.scm -- lualatex -shell-escape -interaction nonstopmode -output-directory %o %f"))
End:
